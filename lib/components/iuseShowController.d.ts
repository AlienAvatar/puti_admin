...
import { UseGetOneHookValue } from 'ra-core';
/**
 ...
 * };
 */
export declare const useShowController: <RecordType extends RaRecord<import("ra-core").Identifier> = any>(props?: ShowControllerProps<RecordType>) => ShowControllerResult<RecordType>;
