 ...
 */
const addUploadCapabilities = dataProvider => (Object.assign(Object.assign({}, dataProvider), { update: (resource, params) => {
        ...
        return Promise.all(newPictures.map(convertFileToBase64))
            ...
            .then(transformedNewPictures => dataProvider.update(resource, Object.assign(Object.assign({}, params), { data: Object.assign(Object.assign({}, params.data), { pictures: [
